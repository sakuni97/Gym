...
<!--        <div class="btn-toolbar mb-2 mb-md-0">
    ...
    <h5><span class="badge bg-primary">
            ...
            <?php
            $sql = "SELECT count(*) FROM tbl_blog_comments";
            $db = dbConn();
            $result = $db->query($sql);
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a style=" width: 100px;" class="btn btn-secondary btn-sm" href="<?php echo $row['comment_status'] == 1 ? 'comment_status.php?comment_id=' . $row['comment_id'] . '&Status=0' : 'comment_status.php?comment_id=' . $row['comment_id'] . '&Status=1'; ?>">
                                    <?php echo $row['comment_status'] == 1 ? 'Disapprove' : 'Approve' ?></a>
                            </td>
                            ...
                            <td class="text-center"><span data-feather="trash"style='color:red;' class="align-text-bottom"></span></td>
                            <td></td>
