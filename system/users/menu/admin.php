<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link <?= @$reports ?>" href="#" onclick="toggleReportTypes()">
                    <span data-feather="bar-chart-2" class="align-text-bottom"></span>
                    Reports
                </a>
                <ul id="reportTypes" style="display: none;">
                    <li><a class="nav-link" href="#"><span data-feather="pie-chart" class="align-text-bottom"></span> Gender summary</a></li>
                    <li><a class="nav-link" href="#"><span data-feather="bar-chart-2" class="align-text-bottom"></span> Report 2</a></li>
                    <li><a class="nav-link" href="#"><span data-feather="bar-chart-2" class="align-text-bottom"></span> Report 3</a></li>
                </ul>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link <?= @$password ?>" href="<?= SYSTEM_PATH ?>admin/password_reset.php">
                    <span data-feather="file" class="align-text-bottom"></span>
                    Password Reset 
                </a>
            </li>
