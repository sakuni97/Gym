...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST" && @$action == 'update') {
        ...
        if (empty($messages)) {
            ...
            $sql = "UPDATE tbl_service SET Image='$file_name_new',Name='$sName',Description='$sDesc' WHERE ServiceId='$ServiceId'";
            $db = dbConn();
            $db->query($sql);
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" enctype="multipart/form-data">
        ...
        <div class="col-md-4">
            <img  style="width: 100px; height: 50px;" class="img-fluid"  src="../../web/assets/img/<?= @$image ?>">
        </div>
