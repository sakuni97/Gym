...
<head>
  ...
  <title>Life Fitness Gym </title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="<?= SYSTEM_PATH ?>assets/img/favicon.png" rel="icon">
  <link href="<?= SYSTEM_PATH ?>assets/img/apple-touch-icon.png" rel="apple-touch-icon">
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
  ...
  <link href="<?= SYSTEM_PATH ?>assets/css/main.css" rel="stylesheet">
