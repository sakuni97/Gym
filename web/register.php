                                        ...
                                        <div class="row g-0">
                                            ...
                                            <div class="col-lg-6  text-white" style="background-color:#0ea2bd;">
                                                <div class="p-5">
                                                    ...
                                                    <div class="mb-4">
                                                        <div class="form-outline form-white">
                                                            <input type="text" id="password" name="mPassword" value="<?= @$mPassword; ?>" class="form-control form-control-lg" />
                                                    ...
                                                    <div class="mb-4">
                                                        <div class="form-outline form-white">
                                                            <input type="text" id="password" name="mConfirmPassword" value="<?= @$mConfirmPassword; ?>" class="form-control form-control-lg" />
                                                    ...
                                                    <div class="form-check d-flex justify-content-start mb-4 pb-3">
                                                        <input class="form-check-input me-3" type="checkbox" value="" id="form2Example3c" name="terms" required="true"/>
