                    ...
                    <div class="post-box">
                        ...
                        <div class="row gy-4 posts-list">
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ?>
                                    <div class="post-img"> <img src="../system/assets/images/blog/<?= $row['Image'] ?>" alt="" class="img-fluid"></div>
                                    <div class="meta">
                                        <?php
                                        $authorid = $row['Author'];
                                ...
                                <span class="post-author"> / <?= $rowauthour['FirstName'] ." " . $rowauthour['LastName'] ?></span>
                            </div>
                            <h3 class="post-title"><?= $row['Title'] ?></h3>
                            <p> <?php echo substr($row['Description'], 0, 200) ?></p>
                            <a href="blog_details.php?Id=<?= $row['Id'] ?> class="readmore stretched-link"><span>Read More</span><i class="bi bi-arrow-right"></i></a>
                        </div>
                    </div>
