...
//        print_r($resetcustomerid);
        echo $sql = "SELECT * FROM tbl_members WHERE passwordreset='$Token' AND MemberId=$resetmemberid";
        $db = dbConn();
    ...
    if (empty($messages)) {
        ...
        echo $sql = "UPDATE tbl_members SET Password = '$Npasswordz' WHERE MemberId= '$resetmemberid' ";
        $results = $db->query($sql);
                    ...
                    <div class="col-md-8">
                        ...
                        <form  method="post"  action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                            ...
                            <div class="container col-md-10">
                                ...
                                <input class="login" type="password" placeholder="Enter New Password" id="UserName" name="Npassword" value="<?= @$Npassword ?>">

                                <label for="uname"><b>Confirm New Password</b></label>
                                <div class="text-danger">  
                                    <?php echo @$messages['error_confirm']; ?>
                                </div>
                                <input class="login" type="password" placeholder="Enter Confirm Password" id="UserName" name="Cpassword" value="<?= @$Cpassword ?>">
